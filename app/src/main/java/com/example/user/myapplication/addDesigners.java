...
public class addDesigners extends AppCompatActivity {
    ArrayList<designer_detail> designers_list;
    RecyclerView designer_recycler;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_designers);
        designers_list = new ArrayList<>();

        designer_recycler = findViewById(R.id.designer_recycler);

        designer_recycler.setLayoutManager(new LinearLayoutManager(addDesigners.this , LinearLayoutManager.VERTICAL, false));
    }

    public void add_designer_Details(View view) {

        startActivity( new Intent(addDesigners.this , designerDetails.class));
    }
