...
public class viewDecorDetails extends AppCompatActivity {
    ...
    public void book_decor(View view) {
        user_home.decorater_name=getIntent().getStringExtra("decoratername");
        user_home.decorater_loc=getIntent().getStringExtra("decoraterloc");
        startActivity( new Intent(viewDecorDetails.this , viewDesigners.class));
    }
}
